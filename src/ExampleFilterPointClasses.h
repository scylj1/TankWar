...
// my class
class MyFilterZoom : public FilterPoints
{
public:

	MyFilterZoom(int xFactor, int yFactor, FilterPoints* pNextFilter = nullptr)
		: pNextFilter(pNextFilter), xStretch(1), yStretch(1), xCompress(1), yCompress(1)
	{
...
class MyFilterScroll : public FilterPoints
{
public:
	MyFilterScroll(int xModifier, int yModifier, FilterPoints* pNextFilter = nullptr)
		: xModifier(xModifier), yModifier(yModifier), pNextFilter(pNextFilter)
	{
	}
